...
$mangaList = [
    [
        ...
        "alternative_title" => "Frieren: Beyond Journey's End",
        "status" => "Hiatus - Chapter 140",
        ...
        "image" => "/pages/FavoriteMangaPage/assets/img/frieren-cover.jpg",
        "link" => "https://myanimelist.net/manga/126287/Sousou_no_Frieren?q=frieren&cat=manga",
    ],
    [
        "title" => "Kaoru Hana wa Rin to Saku",
        "alternative_title" => "The Fragrant Flower Blooms with Dignity",
        "status" => "Ongoing - Chapter 151",
        ...
        "artists" => ["Saka Mikami"],
        "authors" => ["Saka Mikami"],
        "image" => "/pages/FavoriteMangaPage/assets/img/fragrant-flower-cover.jpg",
        "link" => "https://myanimelist.net/manga/144267/Kaoru_Hana_wa_Rin_to_Saku?q=fragrant%20flower&cat=manga",
    ],
    [
        "title" => "Kubo-san wa Mob wo Yurusanai",
        "alternative_title" => "Kubo Won't Let Me Be Invisible",
        "status" => "Completed - 144 Chapters",
        "description" => "First year high schooler Junta Shiraishi is a mob character who goes unnoticed even when he's standing right next to you. But his classmate, \"heroine-level beauty\" Kubo, always notices him and is there to tease him. Anyone can become special to someone, but it might be a little too early to call these feelings \"love.\" Perhaps this story is still two-steps from being a romantic comedy! A sweet comedy where a background character becomes visible!",
        "artists" => ["Nene Yukimori"],
        "authors" => ["Nene Yukimori"],
        "image" => "/pages/FavoriteMangaPage/assets/img/kubo-san-cover.jpg",
        "link" => "https://myanimelist.net/manga/122448/Kubo-san_wa_Mob_wo_Yurusanai?q=kubo%20san&cat=manga",
    ],
    [
        "title" => "Haikyuu!!",
        "alternative_title" => "Haikyu!!",
        "status" => "Completed - 402 Chapters",
        ...
        "artists" => ["Haruichi Furudate"],
        "authors" => ["Haruichi Furudate"],
        "image" => "/pages/FavoriteMangaPage/assets/img/haikyu-cover.jpg",
...
$animeList = [
    [
        "title" => "Sousou no Frieren",
        "alternative_title" => "Frieren: Beyond Journey's End",
        "status" => "Finished Airing<br>Season 2 Announced",
        "studio" => ["Madhouse"],
        "source" => ["Manga"],
        "image" => "/pages/FavoriteAnimePage/assets/img/frieren-anime-cover.jpg",
        "link" => "https://myanimelist.net/anime/52991/Sousou_no_Frieren",
    ],
    [
        "title" => "Kyoukai no Kanata",
        "alternative_title" => "Beyond the Boundary",
        "status" => "Finished Airing",
        "studio" => ["Kyoto Animation"],
        "source" => ["Light Novel"],
        "image" => "/pages/FavoriteAnimePage/assets/img/kyoukai-no-kanata-anime-cover.jpg",
        "link" => "https://myanimelist.net/anime/18153/Kyoukai_no_Kanata",
    ],
    [
        "title" => "Haikyuu!!",
        "alternative_title" => "Haikyu!!",
        "status" => "Finished Airing<br>Next Movie Announced",
        "studio" => ["Production I.G"],
        "source" => ["Manga"],
        "image" => "/pages/FavoriteAnimePage/assets/img/haikyu-anime-cover.jpg",
        "link" => "https://myanimelist.net/anime/20583/Haikyuu",
    ],
    [
        "title" => "Kimetsu no Yaiba",
        "alternative_title" => "Demon Slayer",
        "status" => "Finished Airing<br>Next Movie Announced",
        "studio" => ["ufotable"],
        "source" => ["Manga"],
        "image" => "/pages/FavoriteAnimePage/assets/img/demon-slayer-anime-cover.jpg",
